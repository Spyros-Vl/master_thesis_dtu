...
import sys
sys.path.append('../')
from master_thesis_dtu.src.data.my_rpg_dataset import MultiViewCocoDetection
...
def main():
    ...
    train_dataset = MultiViewCocoDetection(path_folder="data", processor=processor,status='test')
    ...
    best_model = torch.load(f'Best_val_MultiView_DETR_Model.pt',map_location=torch.device('cpu'))
