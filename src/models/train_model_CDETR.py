...
def main():
    ...
    processor = AutoImageProcessor.from_pretrained("microsoft/conditional-detr-resnet-50",num_labels=2,id2label={0:"text",1:"fracture"},ignore_mismatched_sizes=True)
    ...
    #load the model
    model = ConditionalDetrForObjectDetection.from_pretrained("microsoft/conditional-detr-resnet-50",num_labels=len(id2label),id2label={0:"text",1:"fracture"},ignore_mismatched_sizes=True)    
    model.to(device)
