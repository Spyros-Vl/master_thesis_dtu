...
def main():
    ...
    wandb.init(
        ...
        "momentum": 0.9,
        "weight_decay": 0.0005,
        "architecture": "FastRCNN TorchVision Multi-View approach",
    ...
    #load train data
    train_dataset = XRayDataSet(pathlib.Path('s213160/train_pickles_mix'))
    ...
    validation_dataset = XRayDataSet(pathlib.Path('s213160/validation_pickles_mix'))
